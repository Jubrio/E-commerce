// backend/controllers/auth.controller.js — COMPLET
// Ajouts : motDePasseOublie + resetPassword
const bcrypt = require('bcryptjs');
const jwt = require('jsonwebtoken');
const crypto = require('crypto');
const UserDAO = require('../dao/user.dao');
const NotificationDAO = require('../dao/notification.dao');
const TempCodesDAO = require('../dao/tempCodes.dao');   // ← nouveau
...
async verifyEmail(req, res) {
  try {
    ...
    return res.status(201).json({ success: true, message: 'Compte créé avec succès', data: { id, email: record.email, nom: record.nom } });
  } catch (err) {
